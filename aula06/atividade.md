# Livraria
Primeiramente criei o banco de dados no postgres e depois acessei no vscode o banco:
![alt text](image-1.png)

---
## Criação da tabela e seus valores
Logo apos Criei a tabela do meu BCD:

![alt text](image-2.png)

Apos isso adicionei os valores da tabela:
```sql
...
sendo assim limitei a pesquisa dos valores para ate 10, não sobrecarregando o sistema.

---

## 2. Exiba apenas as colunas titulo, autor e preco de todos os livros.

Para exibir colunas específicas utilizei o comando:

![alt text](image-4.png)

assim listei somente os autores e o preço, não o nome do livro.

## 3. Liste os gêneros distintos existentes na base, em ordem alfabética.
Listar somente os gêneros que tem no banco, na ordem alfabetica usa o seguinte comando:

![alt text](image-5.png)

Sendo assim esta selecionando generos distintos da tabela livros e filtrei em ordem alfabetica.

---

## 4. Descubra quantos autores diferentes existem.
Existe um comando que conta quantas linhas tem nossa tabela, ent so utilizarmos ele, na pratica fica:
![alt text](image-7.png)

Sendo assim esta contando quantos autores distintos tem na tabela, no caso 131.

---

## 5. Liste os 5 livros mais caros da base (título e preço).
Para isso seria um filtro com limite, para filtrar utiliza o comando:

![alt text](image-8.png)

assim filtrando os 5 livros mais caros da ordem do maior pro menor

## 6. Liste os 5 livros com menor estoque (título e estoque).
Seria algo pareciso com os mais caros, so que dessa vez queremos com menos quantidade:

![alt text](image-9.png)

A diferença é que quando queremos do maior pro menor, usa o DESC, ja para do menor pro maior Usa o ASC.
...
Assim eu estou fazendo uma busca específica pelo genero Técnico.

### 8. Mostre titulo e preco dos livros que custam mais de R$ 200,00.

Para isso teria que fazer um filtro por titulo e preco de livros que custam mais de 200 reais:

![alt text](image-11.png)

sendo assim fiz a busca de livros e seus preços maiores que 200 reais.

### 9. Mostre titulo e preco dos livros com preço entre R$ 40,00 e R$ 70,00.
Um filtro que busca entre valores:

![alt text](image-12.png)

### 10. Mostre os livros com estoque abaixo de 5 unidades (situação de reposição urgente).
Para isso utilizando um filtro para os livros com estoque menor que 5 unidades. Com o comando:

![alt text](image-13.png)

Assim fazendo um filtro para todos os livros com estoque menor que 5.

---
### 11. Liste os livros publicados antes de 1900, ordenados do mais antigo para o mais recente.

Um filtro para ver todos os livros publicado antes de 1900, do mais antigo pro mais recente usa se o comando:

![alt text](image-14.png)

sendo assimestou filtrando da tabela livros, pelo nome e ano_publicacao seja menor que 1900 para o mais recente ate 1900.

--- 

### Liste os livros publicados entre 2010 e 2020, mostrando título, ano e gênero.

Filtrar pelos livros de 2010 e 202 mostrando seu tiyulo, ano e genero.

![alt text](image-15.png)

sendo assim, filtrando TODOS os livros publicando entre 2010 e 2020.